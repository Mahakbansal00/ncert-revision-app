      ...
      <div className="mt-4">
        {!quiz && (
          <p className="text-sm text-gray-500">
            Click "Generate Quiz" to create questions from the selected PDF.
          </p>
        )}
                ...
                {q.type === "MCQ" &&
                  ...
                  q.options.map((opt, i) => (
                    <button
                      ...
                      className={`block w-full text-left p-2 rounded mt-1 hover:bg-gray-50 ${
                        submittedResult &&
                        submittedResult.correctAnswers[q.id] === opt
